...
import { Card, Button, Tabs, TextInput, Textarea, Label, Select, Badge, Alert } from 'flowbite-react';
import {
  Settings,
  FileText,
  Mic,
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs.Group style="underline">
        <Tabs.Item active={activeTab === 'questions'} title="Questions & TTS" icon={Volume2}>
        ...
        <Tabs.Item title="ASR Settings" icon={Mic}>
          <div className="space-y-4">
        ...
        <Tabs.Item title="Ontologies (OWL/SHACL)" icon={Code}>
        ...
        <Tabs.Item title="System" icon={Settings}>
          <Card>
